...
<div class="max-w-7xl mx-auto p-6 bg-white rounded-lg shadow">
  <div class="flex justify-between items-center mb-4">
    ...
    <a href="{{ route('circuits.create') }}" class="px-4 py-2 bg-blue-600 text-white rounded">Add Circuit</a>
  </div>
    ...
    <tbody class="bg-white divide-y divide-gray-200">
      ...
      <tr>
        ...
        <td class="px-6 py-4 text-right">
          <a href="{{ route('circuits.show', $circuit) }}" class="text-indigo-600 hover:text-indigo-900">View</a>
        </td>
      </tr>
      @endforeach
    </tbody>
